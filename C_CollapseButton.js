/* Cognos CA 11 Sample script.  Will be used to start development for the Cloud & Cognitive Software */
...
C_CollapseButton.prototype.onClick = function( oControlHost )
{
	...
	if ( this.m_sWidth )
	{
		oControl.setWidth( this.m_bCollapsed ? this.m_sWidth : "1px", true );
	}
	if ( this.m_sHeight )
	{
